...
function route(handle, pathname, res, req, data) {
	...
	else if(req.url.indexOf('.woff') != -1){ //req.url has the pathname, check if it conatins '.css'
    ...
    else if(req.url.indexOf('.ttf') != -1){ //req.url has the pathname, check if it conatins '.css'
